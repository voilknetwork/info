              ...
              <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="title_light">
                  ...
                  <ul class="list_none chart_list">
                    ...
                    <li class="color2">Login to Swaper</li>
                    <li class="color3">Complete only 3 Tasks</li>
                    <li class="color4">Get 6.25 VOILKs(it's like getting 6.25 BTC) for FREE</li>
                    <li class="color4">Login to Affiliates</li>
                    <li class="color2">Invite users, get 3.125 VOILKs, for every user</li>
                    <li class="color2">Login to Social media</li>
                    <li class="color2">Participate in Voilk related discussions</li>
                    <li class="color2">Get valued likes from privileged people</li>
                    <li class="color2">When comfortable, invest :)</li>
                  </ul>
